...
class PdfReader extends React.Component {
  constructor() {
    ...
    this.validate = () => {
      ...
      if (!renderType || !source) {
        ...
        (renderType === 'DIRECT_URL' || renderType === 'GOOGLE_READER' || renderType === 'URL_TO_BASE64') &&
        (!source.uri ||
  ...
  componentDidUpdate(prevProps) {
    if (prevProps.source.uri !== this.props.source.uri || prevProps.source.base64 !== this.props.source.base64) {
        ...
        React.createElement(
          ...
          Object.assign(
            ...
            },
            {
              ...
              renderLoading: () => (noLoader ? React.createElement(View, null) : React.createElement(Loader, null)),
            },
            webviewProps
          )
        )
